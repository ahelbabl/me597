...
(defclass <RotateRate> (ros-message)
  ((header
    :reader header-val
    :initarg :header
...
(defmethod serialize ((msg <RotateRate>) ostream)
...
(defmethod deserialize ((msg <RotateRate>) istream)
...
(defmethod serialization-length ((msg <RotateRate>))
  (+ 0
...
(defmethod ros-message-to-list ((msg <RotateRate>))
