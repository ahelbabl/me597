/* Auto-generated by genmsg_cpp for file /home/ahmed/me597/ROS_packages/clearpath_horizon/msg/DifferentialControl.msg */
...
private:
  static const char* __s_getDataType_() { return "clearpath_horizon/DifferentialControl"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "7fc8e33b74ccc82007a751ce82aba911"; }
public:
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, left_p);
    ros::serialization::serialize(stream, left_i);
    ros::serialization::serialize(stream, left_d);
    ros::serialization::serialize(stream, left_ff);
    ros::serialization::serialize(stream, left_sc);
    ros::serialization::serialize(stream, left_il);
    ros::serialization::serialize(stream, right_p);
    ros::serialization::serialize(stream, right_i);
    ros::serialization::serialize(stream, right_d);
    ros::serialization::serialize(stream, right_ff);
    ros::serialization::serialize(stream, right_sc);
    ros::serialization::serialize(stream, right_il);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, left_p);
    ros::serialization::deserialize(stream, left_i);
    ros::serialization::deserialize(stream, left_d);
    ros::serialization::deserialize(stream, left_ff);
    ros::serialization::deserialize(stream, left_sc);
    ros::serialization::deserialize(stream, left_il);
    ros::serialization::deserialize(stream, right_p);
    ros::serialization::deserialize(stream, right_i);
    ros::serialization::deserialize(stream, right_d);
    ros::serialization::deserialize(stream, right_ff);
    ros::serialization::deserialize(stream, right_sc);
    ros::serialization::deserialize(stream, right_il);
    return stream.getData();
  }
  ...
  ROS_DEPRECATED virtual uint32_t serializationLength() const
  {
    ...
    size += ros::serialization::serializationLength(left_p);
    size += ros::serialization::serializationLength(left_i);
    size += ros::serialization::serializationLength(left_d);
    size += ros::serialization::serializationLength(left_ff);
    size += ros::serialization::serializationLength(left_sc);
    size += ros::serialization::serializationLength(left_il);
    size += ros::serialization::serializationLength(right_p);
    size += ros::serialization::serializationLength(right_i);
    size += ros::serialization::serializationLength(right_d);
    size += ros::serialization::serializationLength(right_ff);
    size += ros::serialization::serializationLength(right_sc);
    size += ros::serialization::serializationLength(right_il);
    return size;
  }
