...
(defclass <DistanceTiming> (ros-message)
  ((header
    :reader header-val
    :initarg :header
...
(defmethod serialize ((msg <DistanceTiming>) ostream)
...
(defmethod deserialize ((msg <DistanceTiming>) istream)
...
(defmethod serialization-length ((msg <DistanceTiming>))
  (+ 0
     (serialization-length (slot-value msg 'header))
     4 (reduce #'+ (slot-value msg 'distances) :key #'(lambda (ele) (declare (ignorable ele)) (+ 8)))
))
(defmethod ros-message-to-list ((msg <DistanceTiming>))
